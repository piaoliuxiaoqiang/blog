...
<link rel="alternate icon" type="{{asset('qianduan/image/png')}}" href="{{asset('qianduan/images/favicon.png')}}">
<link rel='icon' href='favicon.ico' type='{{asset('qianduan/image/x-ico')}}' />
